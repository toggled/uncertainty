...
for k in {2..2}; do
   ...
   # done
   python reduce_main.py -k $k -pr $pr -a greedyp -ea $ea -d ER_15_22 -q data/queries/ER/ER_15_22_2.queries &
   # python reduce_main.py -k $k -pr $pr -a greedy -ea $ea -d ER_15_22 -q data/queries/ER/ER_15_22_4.queries &
done
# for K in "${NT_array[@]}"; do
#    # python reduce_main.py -k $k  -pr $pr  -a greedymem -K $K -ea exact -d ER_15_22 -q data/queries/ER/ER_15_22_2.queries &
#    python reduce_main.py -k 4  -pr $pr  -a greedymem -K $K -ea $ea -d ER_15_22 -q data/queries/ER/ER_15_22_4.queries &
# done
python reduce_main.py -k 4 -pr $pr -a greedyp -ea $ea -d ER_15_22 -q data/queries/ER/ER_15_22_4.queries &
# python reduce_main.py -k 4 -pr $pr -a exact -d ER_15_22 -q data/queries/ER/ER_15_22_4.queries &
# for k in {1..2}; do
